          ...
          <div className='flex w-full justify-center'>
            <div className='rounded-xl bg-white px-10 py-6 shadow-lg lg:w-10/12 xl:w-[70%]'>
              <div className='flex justify-center text-2xl font-bold'>
                {dataSubject?.code} - LƯỢNG GIÁ MÔN HỌC
              </div>
              <div className='mt-5'>
                Chủ đề:{' '}
              ...
              <Form
                layout='vertical'
                form={form}
                name='form-subject-evaluation'
              >
                <div className='mb-1 text-sm'>
                  1. Bạn đánh giá như thế nào về chất lượng của bài giảng hôm
                  nay?
                </div>
                <div className='ml-6'>
                ...
                <Form.Item
                  name={'invited'}
                  label={
                    '3. Từ những điều tâm đắc trên, bạn được mời gọi làm gì?'
                  }
                  rules={[
                    {
                      required: true,
                ...
                <Form.Item
                  name={'satisfied'}
                  label={
                    '5. Mức độ hài lòng chung của bạn đối với lớp học hôm nay?'
                  }
                  rules={[
                    {
                      required: true,
                ...
                {size(dataSubjectEvaluationQuestions?.questions) &&
                  map(
                    dataSubjectEvaluationQuestions?.questions,
                    (item, idx) => (
